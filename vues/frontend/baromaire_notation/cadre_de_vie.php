        ...
        <div class="accordeon mt-4">
            <div class="row">
                ...
                <div class="accordeon_body col-9 p-0 pl-3 pb-2">
                    <!-- title -->
                    <div class="accordeon_body--title font-20 text-right pr-3 pt-1"><?= $accordeons['title'] ?></div>
                    <!-- divider -->
...
<!-- sidebar menu .active -->
<?php if(isset($_GET['quartier']) && $_GET['quartier'] == 1) { ?>
<script>var child = 3;</script>
<?php } else if (isset($_GET['quartier']) && $_GET['quartier'] == 2) { ?>
